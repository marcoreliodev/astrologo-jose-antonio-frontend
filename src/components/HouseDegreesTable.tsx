      ...
      <table className="w-full text-left text-sm">
        <thead>
          <tr className="border-b border-line text-xs font-semibold uppercase tracking-wide text-ink-soft">
            <th className="px-5 py-2.5">Casa</th>
            <th className="px-5 py-2.5">Signo</th>
            <th className="px-5 py-2.5">Grau</th>
          </tr>
        </thead>
        <tbody>
          {ordered.map((cusp) => (
            <tr key={cusp.house} className="border-b border-line last:border-0">
              ...
              <td className="whitespace-nowrap px-5 py-2.5 font-medium text-noturno">
